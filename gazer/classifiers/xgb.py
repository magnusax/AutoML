...
class MetaXGBoostClassifier(BaseClassifier):
    """
    Classifier from the xgbbost project 
    adapted to sklearn api.
    ...
    def __init__(self, max_depth=3, learning_rate=0.1, n_estimators=100, silent=True, objective='binary:logistic', 
        ...
        # We might need to change 'objective' to account 
    ...
    def _set_cv_params(self):
        ...
        return [{
            ...
            'reg_lambda': _uniform(0.1, 10),
            'base_score': _uniform(0.1, 0.9),
            'scale_pos_weight': _uniform(0.1, 10),
        }]
